...
## Project Structure
    ...
    ├── restless_butterfly_30251  # Django project configurations
...
1. Clone this repo and `cd restless_butterfly_30251`
...
2. Clone this repo and `cd restless_butterfly_30251`
